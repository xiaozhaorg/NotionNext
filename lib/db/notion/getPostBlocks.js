...
import { normalizeExternalImageBlock } from '@/lib/db/notion/normalizeExternalImageBlock'
...
export function formatNotionBlock(block) {
  ...
  for (let i = 0; i < blocksToProcess.length;) {
    ...
    normalizeExternalImageBlock(b?.value)
...
function sanitizeBlockUrls(blockValue) {
  ...
  if (blockValue.type === 'image') {
    ...
    if (externalUrl && typeof externalUrl === 'string') {
      ...
      blockValue.properties.source[0][0] = fixedUrl
